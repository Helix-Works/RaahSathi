...
export const enMessages = {
  ...
  applications: {
    ...
    nextPayment: "Payment is the next backend step",
    blockingIdentity: "Identity verification is required. All completed application sections remain saved.",
    blockingPayment: "Identity is verified. Payment is required, but payment UI is not part of this build.",
    paymentUnavailableTitle: "Payment is not available yet",
    paymentUnavailableDescription: "Your application is safely ready for payment. Frontend Phase 4 will connect payment after authoritative backend contracts exist.",
  ...
  identity: {
    ...
    verifiedDescription: "Identity is verified. The application is ready for the future payment phase.",
