...
export const enMessages = {
  ...
  applications: {
    ...
    fullName: "Full name",
    fullNameHelp: "Use fictional test information only; never enter real personal data. Enter a name between 2 and 80 characters.",
    dateOfBirth: "Date of birth",
    dateOfBirthHelp: "Use a fictional test date only. Enter the date in the format shown.",
    district: "Delhi district",
    postalCode: "Delhi postal code",
    postalCodeHelp: "Use a fictional test address only. Enter a six-digit Delhi postal code beginning with 11.",
    vehicleClass: "Vehicle class",
    learnerReference: "Learner-licence reference",
    learnerReferenceHelp: "Use a fictional test reference only. Enter the learner reference associated with this application.",
  ...
  auth: {
    ...
    mobileHelp: "Enter the mobile number registered for this account.",
    requestOtp: "Send OTP",
    ...
    otpHelp: "Enter the six-digit one-time password for this sign-in request.",
