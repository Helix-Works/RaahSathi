...
export const apiErrors = {
  ...
  eligibleLicenceRequired: () => new ApiError(409, "ELIGIBLE_LICENCE_REQUIRED", "applications.errors.eligibleLicenceRequired"),
  addressUnchanged: () => new ApiError(409, "ADDRESS_UNCHANGED", "applications.errors.addressUnchanged"),
  serviceAppointmentNotApplicable: () => new ApiError(409, "SERVICE_APPOINTMENT_NOT_APPLICABLE", "appointments.errors.serviceNotApplicable"),
