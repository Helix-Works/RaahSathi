...
describe("displayReference", () => {
  ...
  it("keeps enough of an application ID to distinguish citizen-facing references", () => {
    expect(displayApplicationReference("a0000000-0000-4000-8000-000000000001")).toBe("RS-800000000001");
    expect(displayApplicationReference("a0000000-0000-4000-8000-000000000002")).toBe("RS-800000000002");
  });
});
